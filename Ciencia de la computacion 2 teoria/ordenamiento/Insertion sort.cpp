...
void insercion(int lista[],const int longitud){
    int valorActual,posicion;//la variable posicion nos servira para almacenar la posicion, y el valor actual nos servira para realizar el intercambio de los numeros 
